...
## Notes for strathclyde deployment
In order for the compilation tests to be run correctly, a new tag must be published in the format `v2.x.x-beta` where `x` is a number.
